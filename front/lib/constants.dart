...
const String URI_CREATE_TOUCH_SITE = "${IP_ADDRESS}CreateTouchSite";
...
const String URI_DELETE_TOUCH_SITE = "${IP_ADDRESS}DeleteTouchSite";
const String URI_GET_ALL_BRANCHES = "${IP_ADDRESS}GetAllBranches";
const String URI_GET_ALL_TOUCH_SITES = "${IP_ADDRESS}GetTouchSites";
