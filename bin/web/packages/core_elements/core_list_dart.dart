...
class CoreList extends PolymerElement with ChangeNotifier  {
  /**
   ...
   * @default null
   */
  @reflectable @published ObservableList get data => __$data; ObservableList __$data; @reflectable set data(ObservableList value) { __$data = notifyPropertyChange(#data, __$data, value); }
   ...
   * @default null
   */
  @reflectable @published ObservableList<CoreListGroup> get groups => __$groups; ObservableList<CoreListGroup> __$groups; @reflectable set groups(ObservableList<CoreListGroup> value) { __$groups = notifyPropertyChange(#groups, __$groups, value); }
   ...
   * @default true
   */
  @reflectable @published bool get selectionEnabled => __$selectionEnabled; bool __$selectionEnabled = true; @reflectable set selectionEnabled(bool value) { __$selectionEnabled = notifyPropertyChange(#selectionEnabled, __$selectionEnabled, value); }
   ...
   * @default false
   */
  @reflectable @published bool get multi => __$multi; bool __$multi = false; @reflectable set multi(bool value) { __$multi = notifyPropertyChange(#multi, __$multi, value); }
   ...
   * @default null
   */
  @reflectable @published dynamic get selection => __$selection; dynamic __$selection; @reflectable set selection(dynamic value) { __$selection = notifyPropertyChange(#selection, __$selection, value); }
   ...
   * @default false
   */
   @reflectable @published bool get grid => __$grid; bool __$grid = false; @reflectable set grid(bool value) { __$grid = notifyPropertyChange(#grid, __$grid, value); }
   ...
   * @default null
   */
   @reflectable @published int get width => __$width; int __$width; @reflectable set width(int value) { __$width = notifyPropertyChange(#width, __$width, value); }
   ...
   * @default 200
   */
  @reflectable @published int get height => __$height; int __$height = 200; @reflectable set height(int value) { __$height = notifyPropertyChange(#height, __$height, value); }
   ...
   * @default 4
   */
  @reflectable @published int get runwayFactor => __$runwayFactor; int __$runwayFactor = 4; @reflectable set runwayFactor(int value) { __$runwayFactor = notifyPropertyChange(#runwayFactor, __$runwayFactor, value); }
...
class CoreListGroup extends ChangeNotifier {
  @reflectable @observable int get length => __$length; int __$length; @reflectable set length(int value) { __$length = notifyPropertyChange(#length, __$length, value); }
  @reflectable @observable dynamic get data => __$data; dynamic __$data; @reflectable set data(dynamic value) { __$data = notifyPropertyChange(#data, __$data, value); }
  CoreListGroup({length, data}) : __$length = length, __$data = data;
}
...
class _ListModel extends ChangeNotifier {
  @reflectable @observable int get physicalIndex => __$physicalIndex; int __$physicalIndex; @reflectable set physicalIndex(int value) { __$physicalIndex = notifyPropertyChange(#physicalIndex, __$physicalIndex, value); }
  @reflectable @observable int get index => __$index; int __$index; @reflectable set index(int value) { __$index = notifyPropertyChange(#index, __$index, value); }
  ...
  @reflectable @observable dynamic get model => __$model; dynamic __$model; @reflectable set model(dynamic value) { __$model = notifyPropertyChange(#model, __$model, value); }
  @reflectable @observable CoreListGroup get groupModel => __$groupModel; CoreListGroup __$groupModel; @reflectable set groupModel(CoreListGroup value) { __$groupModel = notifyPropertyChange(#groupModel, __$groupModel, value); }
  @reflectable @observable int get groupIndex => __$groupIndex; int __$groupIndex; @reflectable set groupIndex(int value) { __$groupIndex = notifyPropertyChange(#groupIndex, __$groupIndex, value); }
  @reflectable @observable int get groupItemIndex => __$groupItemIndex; int __$groupItemIndex; @reflectable set groupItemIndex(int value) { __$groupItemIndex = notifyPropertyChange(#groupItemIndex, __$groupItemIndex, value); }
}
